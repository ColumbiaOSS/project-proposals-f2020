...
![Repo's Page](https://github.com/Luigi-PastorePica/COMS4995)
...
- Draw a graph that shows the projected variation of the different balances based on current data.
